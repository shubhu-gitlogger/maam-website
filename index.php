...
<main id="main">
	...
	<div class="container">
		...
		<div class="row section topspace">
			<div class="col-md-12">
				<p class="lead text-center text-muted">Welcome to the official website  of Dr. Rama Bansode, an experienced educator specializing in Mathematics, Networking, and Software Testing. With a passion for teaching and a commitment to simplifying complex concepts, Dr. Bansode provides valuable insights, resources, and guidance to students and professionals alike. Explore the site to learn more about her expertise, courses, and contributions to the field of education.</p>
			</div>
		</div> <!-- / section -->
